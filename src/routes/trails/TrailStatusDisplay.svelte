<script lang="ts">
   ...
   <line x1="12" y1="16" x2="12.01" y2="16"></line>
			...
			break;
		case 'warning':
			icon = `<svg xmlns="http://www.w3.org/2000/svg" class="${iconClasses} stroke-warning" viewBox="0 0 24 24" stroke-width="2.25" fill="none" stroke-linecap="round" stroke-linejoin="round">
   <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
   ...
   <line x1="12" y1="16" x2="12.01" y2="16"></line>
			...
			break;
		case 'success':
			icon = `<svg xmlns="http://www.w3.org/2000/svg" class="${iconClasses} text-success" viewBox="0 0 24 24" stroke-width="2.25" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
   <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
   <circle cx="12" cy="12" r="9"></circle>
