<script lang="ts">
	import LatestTrails from '$lib/components/LatestTrails.svelte';
...
<LatestTrails {latestSystems} />

<h2 class="text-lg font-bold">Add a trail system</h2>

<div class="mt-4">
	Before you fill out this form, please make sure that the system doesn't exist under a similar name
	by using the <a href="/trails/systems/search" class="link link-primary">Trail system search</a>.
</div>
